...
source_list =['data/Cdata/val/B'] #, 'data/Cdata/train/B', 'data/Cdata/test/A', 'data/Cdata/test/B', 'data/Cdata/val/A', 'data/Cdata/val/B']
...
for source_dir in source_list:
    for filename in os.listdir(source_dir):
        ...
        with Image.open(file_path) as img:
            print("size: ", img.size, "filecount", filecount)
        #         # Resize the image
