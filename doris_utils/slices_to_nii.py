        ...
        for b in range(1, num_slices_b + 1):
            ...
            for a in range(1, num_slices_a + 1):
                if data_type == 'pred':
                    ...
                    folder_name = f"img_TOW{scan_id}__slice_{a}_{b}.jpg"  # Assuming .png for simplicity
...
create_nifti_from_slices(
    ...
    num_slices_a=88, 
    num_slices_b=15, 
    scan_ids=['018','143', '144'], 
    output_directory="my-rdisk/r-divi/RNG/Projects/stages/Pim/Doris/BBDM_Thesis/Unet_input/scans_gt", 
    input_directory="my-rdisk/r-divi/RNG/Projects/stages/Pim/Doris/BBDM_Thesis/data/processed2_cropped/train/A",
    data_type='gt'  # Or 'pred'
)
