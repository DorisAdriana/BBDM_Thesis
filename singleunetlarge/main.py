...
class UNet(nn.Module):
    def __init__(self):
        ...
        self.enc1 = EncoderBlock(1, 64, dropout=0.1)  # Changed from 16 to 64
        self.enc2 = EncoderBlock(64, 128, dropout=0.1)  # Changed from 32 to 128
        self.enc3 = EncoderBlock(128, 256, dropout=0.2)  # Changed from 64 to 256
        self.enc4 = EncoderBlock(256, 512, dropout=0.2)  # Changed from 128 to 512
        self.bridge = ConvBlock(512, 1024, dropout=0.3)  # Changed from 128 to 1024
        self.dec1 = DecoderBlock(1024, 512, 512, dropout=0.2)  # Changed from 256, 128 to 1024, 512, 512
        self.dec2 = DecoderBlock(512, 256, 256, dropout=0.2)  # Changed from 128, 64 to 512, 256, 256
        self.dec3 = DecoderBlock(256, 128, 128, dropout=0.1)  # Changed from 64, 32 to 256, 128, 128
        self.dec4 = DecoderBlock(128, 64, 64, dropout=0.1)  # Changed from 32, 16 to 128, 64, 64
        self.final = nn.Conv2d(64, 1, kernel_size=1)  # Output channel is 1
