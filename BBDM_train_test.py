...
destination_folders = {'velx': 'my-rdisk/r-divi/RNG/Projects/stages/Pim/Doris/BBDM_Thesis/data/slices_n98_s320x320_z88_velx/test',
                       'vely': 'my-rdisk/r-divi/RNG/Projects/stages/Pim/Doris/BBDM_Thesis/data/slices_n98_s320x320_z88_vely/test',
                       'velz': 'my-rdisk/r-divi/RNG/Projects/stages/Pim/Doris/BBDM_Thesis/data/slices_n98_s320x320_z88_velz/test'}

# Function to copy files for the first 20 scans
def copy_files_for_scans(source, destination):
    # Loop through the first 2s0 scans
    for scan in testfolders: ### CHANGE THIS
